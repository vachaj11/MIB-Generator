...
Attributes:
    ...
    xls_heads (dict): A dictionary holding definitions of header rows for each of the sheets in the .xls output tables.
"""
pid = [
...
xls_heads = {
    "TM Packet": [
        [
            ...
            "Mnemonic",
            "SCOS2K Packet ID",
            "TM Packet Ident Criteria",
            "APID",
            "Ident1 Value",
            "Ident2 Value",
            "Variable Packet Header Length",
            "Total Size",
            "Subsystem",
            "Description",
            "Time Present",
        ...
        [
            "TM Packet Fixed Element Definition",
            "",
            "TM Parameter",
            "Byte Offset",
            "Bit Offset",
            "Repeat Counter",
            "Bits Between Repeat",
            "Offset to Packet Time",
            "Msec between Occurrences",
        ],
        [
            "TM Packet Variable Element Definition",
            "",
            "Variable Structure ID",
            "TM Parameter",
            "Position",
    ...
    "TC TxtCal": [
        [
            "TC TxtCal Definition",
            "Mnemonic",
            "Description",
            "Raw Format",
            "Number of Ranges",
        ],
        ["TC TxtCal Alias Definition", "", "Raw Value", "Alias"],
    ],
    "TM NumCal": [
        [
            "NumCal Definition",
        ...
        ["NumCal Points Definition", "", "Raw Value", "Eng Value"],
    ],
    "TM TxtCal": [
        [
            "TxtCal Definition",
        ...
        ["TxtCal Ranges Definition", "", "Range from", "Range to", "Alias"],
    ],
    "TM LogCal": [
        [
            "LogCal Definition",
    ...
    "TC Value Set": [
        [
            "TC Value Set Definition",
            "Mnemonic",
            "Name",
            "Description",
        ],
        [
            "TC Param Values Definition",
            "",
            "",
            "",
            "TC Element",
    ...
    "TC Param Set": [
        [
            "TC Param Set Definition",
            "Mnemonic",
            "Description",
        ],
        ["TC Param Set Map Definition", "", "", "TC"],
        ["TC Value Sets Definition", "", "", "", "TC Value Set"],
    ],
    "D Alph": [
        [
            "AnDisplay Definition",
            "Mnemonic",
            "Type",
            "Header",
            "Number",
